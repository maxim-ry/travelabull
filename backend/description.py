...
def get_summeryies(user_city,user_rate,user_type):
    ...
    for i in range(0, 3):
        ...
        text_to_summarize = f"""
        Generate a concise and captivating summary of location {user_city[i]} for a {user_type[i]} traveler.
...
def get_summeryies_of_summary(user_city, user_rate, user_type):
    ...
    text_to_summarize_summery = f"""
            Generate combined concise and captivating summary of the {get_summeryies(user_city,user_rate,user_type)} of for a traveler and vacationer.
            # Combines all summaries is 2-3 sentences long and aims to spark curiosity and make the visit memorable.
